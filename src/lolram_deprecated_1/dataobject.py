...
class Context(ProtectedObject):
	...
	def __init__(self, id=None, request=None, #@ReservedAssignment
	...
	def page_info(self, limit=10, all=None, more=False): #@ReservedAssignment
...
class URL(lolram.util.url.URL, ProtectedObject):
	__slots__ = ()
	
	def __init__(self, *args, **kargs):
		lolram.util.url.URL.__init__(self, *args, **kargs)
...
models.BaseModel):
	...
	def render(self, context, format, **opts): #@ReservedAssignment
...
class PageInfo(models.BaseModel):
	def __init__(self, offset=None, limit=50, all=None, more=None, page=None, #@ReservedAssignment
