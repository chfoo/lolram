...
from lolram_deprecated_1.components.cms import CMS
from lolram_deprecated_1.components.cms.dbdefs import ArticleActions, \
	ArticleViewModes, ArticleMetadataFields
from lolram_deprecated_1.components.lion import Lion
from lolram_deprecated_1.dataobject import MVPair
from lolram_deprecated_1.views import LabelURLToLinkView, BaseView
from lolram_deprecated_1.widgets import Document, NavigationBox, Link, Pager, \
	Table, Form, TextBox, OptionGroup, Option, Button, HorizontalBox, Text, \
	VerticalBox
...
def _build_edit_page(context, article_version, upload=False):
	if not lolram_deprecated_1.components.accounts.serve.serve_captcha(context):
		return
