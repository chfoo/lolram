...
from lolram_deprecated_1.components.accounts import CaptchaValidator, \
	AccountManager
from lolram_deprecated_1.components.accounts.dbdefs import AccountLogsMeta
...
from lolram_deprecated_1.widgets import Document, NavigationBox, Link, Pager, \
	Table, Form, TextBox, Button, OptionGroup, Option, BaseWidget
from lolram_deprecated_2.openid import OpenIDProvidersInfo
