'''Records (Python recipe) http://code.activestate.com/recipes/576555/

This is a recipe similar in functionality and exec-style optimized 
implementation to the very well received namedtuple 
(http://code.activestate.com/recipes/500261/) that was included in Python 2.6. 
The main difference is that records, unlike named tuples, are mutable. In 
addition, fields can have a default value. Instead of subclassing tuple or 
list, the implementation create a regular class with __slots__.
'''

# Created by George Sakkis on Tue, 4 Nov 2008
