...
#
import lolram.deprecated.web.headers
import unittest
...
class TestHeaders(unittest.TestCase):
    def test_header_list_to_dict(self):
        ...
        result = lolram.deprecated.web.headers.header_list_to_dict(
            WSGI_HEADER_LIST)
    ...
    def test_header_dict_to_list(self):
        ...
        result = lolram.deprecated.web.headers.header_dict_to_list(
            WSGI_HEADER_DICT)
    ...
    def test_header_dict_mapping_to_list(self):
        ...
        result = lolram.deprecated.web.headers.HeaderListMap(
            WSGI_HEADER_LIST).to_list()
        self.assertEqual(sorted(WSGI_HEADER_LIST), sorted(result))
