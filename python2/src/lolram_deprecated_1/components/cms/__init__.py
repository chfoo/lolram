...
from lolram.util import restpub
from lolram_deprecated_1.components.accounts import AccountManager
from lolram_deprecated_1.components.base import BaseGlobalComponent, \
	BaseComponent
from lolram_deprecated_1.components.cache import Cache
from lolram_deprecated_1.components.cms.dbdefs import CMSArticlesMeta, \
	CMSArticleTreeMeta, CMSHistoryMeta, CMSAddressesMeta, CMSArticleMPTreeMeta, \
	ArticleMetadataFields, ArticleViewModes
from lolram_deprecated_1.components.database import Database
from lolram_deprecated_1.components.lion import Lion
from lolram_deprecated_1.components.respool import ResPool
from lolram_deprecated_1.dataobject import ProtectedObject
from lolram_deprecated_1.models import BaseModel
...
class CMS(BaseComponent):
	...
	def model_uuid_str(cls, model):
		return lolram_deprecated_1.util.bytes_to_b32low(model.uuid_bytes)
