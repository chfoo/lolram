...
from lolram_deprecated_1 import dataobject, views, models, util
from lolram_deprecated_1.backports import ordereddict
from lolram_deprecated_1.components.session import Session
from lolram_deprecated_1.models import BaseModel
from lolram_deprecated_1.views import DocumentView
import os
...
class BaseWidget(object):
	...
	@id.setter
	def id(self, s): #@ReservedAssignment
		self._id = s
	...
	def render(self, context, format): #@ReservedAssignment
