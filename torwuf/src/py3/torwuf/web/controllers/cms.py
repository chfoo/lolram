...
class DownloadHandler(torwuf.web.controllers.base.BaseHandler, HandlerMixin,
StaticFileMixIn):
    name = 'cms_download'
...
class ResizeHandler(torwuf.web.controllers.base.BaseHandler, HandlerMixin,
StaticFileMixIn):
    name = 'cms_resize'
    SIZE_THUMBNAIL = 75
    SIZE_PREVIEW = 500
...
class BaseEditArticleHandler(torwuf.web.controllers.base.BaseHandler,
HandlerMixin):
...
class BaseEditFileHandler(torwuf.web.controllers.base.BaseHandler,
HandlerMixin):
