...
def require_admin(fn):
    ...
    def wrapper(self, *args, **kargs):
        ...
        and self.controllers['AuthorizationController'].is_admin_account(
            self.current_account_uuid) \
...
def require_group(*group):
    def decorator_wrapper(fn):
        ...
        def wrapper(self, *args, **kargs):
            if self.current_account_id \
            and self.controllers['AuthorizationController'].\
            is_account_in_group(self.current_account_uuid, *group) \
            or self.is_testing_key_valid():
                return fn(self, *args, **kargs)
