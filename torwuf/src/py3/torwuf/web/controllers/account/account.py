...
class EditProfileHandler(torwuf.web.controllers.base.BaseHandler,
HandlerMixIn):
...
class NewFederatedAccountHandler(torwuf.web.controllers.base.BaseHandler,
HandlerMixIn):
...
class OpenIDSuccessHandler(torwuf.web.controllers.base.BaseHandler,
HandlerMixIn):
...
class SwitchAccountHandler(torwuf.web.controllers.base.BaseHandler,
HandlerMixIn):
