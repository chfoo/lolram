...
class OpenIDController(torwuf.deprecated.web.controllers.base.BaseController):
    def init(self):
...
class ShowOpenIDHandler(torwuf.deprecated.web.controllers.base.BaseHandler):
...
class OpenIDBaseHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
ProcessingMixIn):
...
class LoginHandler(OpenIDBaseHandler):
    ...
    def get(self):
        ...
        if self.get_openid_failure_flag():
            render_dict['layout_message_title'] = self.locale.translate(
                'There was a problem signing in')
            render_dict['layout_message_body'] = self.locale.translate(
