...
#
from lolram.deprecated.web.framework.mixins import StaticFileMixIn
from tornado.web import HTTPError
from torwuf.deprecated.web.controllers.account.authorization.decorators import \
    require_admin
from torwuf.deprecated.web.models.cms import ArticleCollection, TagCountCollection, \
    TagCollection
from torwuf.deprecated.web.resource import make_map_tags_code, make_reduce_tags_code
from torwuf.deprecated.web.utils import tag_list_to_str, bytes_to_b32low_str, \
    b32low_str_to_bytes
import base64
...
class CMSController(torwuf.deprecated.web.controllers.base.BaseController):
    @property
    ...
    def init(self):
        ...
        self.add_url_spec(r'/a/([0-9a-zA-Z]+);resize=([0-9a-zA-Z]+)',
            ResizeHandler)
        ...
        self.add_url_spec(r'/cms/article/delete/([0-9a-f]+)',
    ...
    def render_text(self, text):
        doc_info = lolram.restdoc.publish_text(text)
    ...
    def generate_tag_count_collection(self):
        ...
        results = self.application.database[TagCountCollection.COLLECTION
            ].find()
...
class HandlerMixin(object):
    ...
    def get_disk_file_path(self, hash_str):
        ...
        return os.path.join(self.app_controller.config.upload_path, 'cms',
            hash_str[0:2], hash_str[2:4], hash_str[4:6], hash_str)


class UniqueItemHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin):
...
class DownloadHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin, StaticFileMixIn):
    name = 'cms_download'
...
class ResizeHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin, StaticFileMixIn):
    name = 'cms_resize'
    SIZE_THUMBNAIL = 75
    SIZE_PREVIEW = 500
...
class BaseEditArticleHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin):
...
class DeleteArticleHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin):
...
class BaseEditFileHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin):
...
class LookupFileHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin):
...
class AllTagsHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin):
    name = 'cms_all_tags'
...
class TagHandler(torwuf.deprecated.web.controllers.base.BaseHandler, HandlerMixin):
    name = 'cms_tag'
...
class AllArticlesHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin):
...
class AtomFeedHandler(torwuf.deprecated.web.controllers.base.BaseHandler,
HandlerMixin):
    name = 'cms_atom_feed'
