...
#
from torwuf.deprecated.web.controllers.account.authentication.mixins import \
    AuthenticationHandlerMixIn
from torwuf.deprecated.web.controllers.session.mixin import SessionHandlerMixIn
from torwuf.deprecated.web.utils import json_serializer
import json
import logging
import lolram.deprecated.web.framework.app
import torwuf.deprecated.web.controllers.error
...
torwuf.deprecated.web.controllers.error.ErrorOutputHandlerMixin,
SessionHandlerMixIn,
AuthenticationHandlerMixIn,
):
    ...
    def write_error(self, *args, **kargs):
        torwuf.deprecated.web.controllers.error.\
