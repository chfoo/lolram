...
class IndexController(torwuf.deprecated.web.controllers.base.BaseController):
    def init(self):
...
class IndexRequestHandler(torwuf.deprecated.web.controllers.base.BaseHandler):
    name = 'index'
...
class AboutHandler(torwuf.deprecated.web.controllers.base.BaseHandler):
    name = 'about'
...
class ProjectsHandler(torwuf.deprecated.web.controllers.base.BaseHandler):
    name = 'projects'
...
class CatchAllRequestHandler(torwuf.deprecated.web.controllers.base.\
BaseHandler):
    name = 'catch_all'

    def get(self, arg):
        handlers = self.app_controller.wsgi_application._get_host_handlers(
            self.request)
...
class MisconfiguredDummyAppHandler(torwuf.deprecated.web.controllers.base.\
BaseHandler):
...
class MissingStaticFilesHandler(torwuf.deprecated.web.controllers.base.\
BaseHandler):
