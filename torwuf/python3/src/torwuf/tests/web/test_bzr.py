...
class TestBzr(unittest.TestCase, torwuf.tests.web.server_base.ServerBaseMixIn):
	def setUp(self):
		self.create_app()
		self.start_server()
	...
	def test_sequence(self):
		...
		http_auth_value = 'Basic ' + str(base64.b64encode(bytes('{}:{}'.format(username, password), 'utf8')), 'utf8')
