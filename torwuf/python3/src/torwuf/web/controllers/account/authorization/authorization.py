...
class AuthorizationController(torwuf.web.controllers.base.BaseController):
	def init(self):
	...
	def is_admin_account(self, account_id):
		...
		result = self.application.database[AccountCollection.COLLECTION].find_one({
			'_id': account_id,
...
class AddGroupHandler(torwuf.web.controllers.base.BaseHandler):
	...
	def post(self, account_uuid_str):
		...
		self.controller.application.database[AccountCollection.COLLECTION].update(
			{'_id': uuid_obj},
			{'$set':
