...
class DefaultHandler(torwuf.web.controllers.base.BaseHandler):
	def get(self):
		self.redirect('/account/profile')

class LoginHandler(torwuf.web.controllers.base.BaseHandler):
	def get(self):
...
class LogoutHandler(torwuf.web.controllers.base.BaseHandler):
	name = 'account_logout'
...
class ProfileHandler(torwuf.web.controllers.base.BaseHandler, HandlerMixIn):
	...
	def get(self):
		...
		self.render('account/profile.html', AccountCollection=AccountCollection,
			db_model=result)
...
class NewFederatedAccountHandler(torwuf.web.controllers.base.BaseHandler, HandlerMixIn):
	...
	def post(self):
		...
		result = self.account_collection.find_one({
			AccountCollection.OPENID_ID_URLS: session_data[SuccessSessionKeys.OPENID],
...
class OpenIDSuccessHandler(torwuf.web.controllers.base.BaseHandler, HandlerMixIn):
...
class SwitchAccountHandler(torwuf.web.controllers.base.BaseHandler, HandlerMixIn):
...
class PostLoginHandler(torwuf.web.controllers.base.BaseHandler):
