# $Id: io.py 7196 2011-10-20 23:04:46Z milde $
            ...
            if source_path:
                ...
                try:
                    ...
                    print(('Unable to open source'
                        " file for reading ('%s'). Exiting." % source_path), file=self._stderr)
                    sys.exit(1)
            else:
...
class FileOutput(Output):
    ...
    def write(self, data):
        ...
        try: # In Python < 2.5, try...except has to be nested in try...finally.
            ...
            except (UnicodeError, LookupError) as err: # can only happen in py3k
                raise UnicodeError(
